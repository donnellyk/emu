...
extension Instruction {
  ...
  func opCodeString(nextByte: UInt8, nextWord: UInt16) -> String {
    switch opcode {
    ...
    case 0xCB: return opCodeExtensionString(nextByte: nextByte)
...
private extension Instruction {
  func opCodeExtensionString(nextByte: UInt8) -> String {
    switch nextByte {
    ...
    default: return "---UNKNOWN INT EXT---"
    }
  }
}
